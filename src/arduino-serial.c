...
void usage(void)
{
    printf("Usage: arduino-serial -b  -p  [OPTIONS]\n"
    "\n"
    "Options:\n"
    ...
    "  -l  --loop                 Loop, read and echo serial input\n"
    "\n"
...
int main(int argc, char *argv[])
{
    ...
    while(1) {
        opt = getopt_long (argc, argv, "hp:b:s:S:i:rFn:d:qe:t:l",
